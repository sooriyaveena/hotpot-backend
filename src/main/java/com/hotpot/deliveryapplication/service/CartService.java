...
public class CartService {
    ...
    public CartResponse addItemToCart(int userId, int itemId, int quantity) {
        ...
        cart.getCartItems().stream()
                .filter(ci -> ci.getMenuItem().getItemId() == itemId)
                .findFirst()
                .ifPresentOrElse(ci -> {
        ...
        return mapper.toCartResponse(cr.save(cart));
    }


    public CartResponse updateItemQuantity(int userId, int itemId, int change) {
        ...
        int newQty = ci.getQuantity() + change;
    ...
    public CartResponse removeItem(int userId, int itemId) {
        ...
        cart.getCartItems().removeIf(ci ->
                ci.getMenuItem().getItemId() == itemId
        );
